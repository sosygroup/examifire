...
var KTDatatablesAdvancedColumnRendering = function() {
	...
	var initTable1 = function() {
		...
		var table = $('#kt_datatable').DataTable({
			...
			ajax:{
			    url: MY_HOST_URL+'/home/admin/student/list-datatable',
			    type: 'GET'
		    },
		    columns: [
				{data: 'id'},
				...
				{data: null,
					...
					render: function(data, type, full, meta) {
						...
						<a href="'+MY_HOST_URL+'/home/admin/student/edit/'+full["id"]+'/account-info'+'" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
							<i class="la la-edit"></i>\
						</a>\
						<a href="'+MY_HOST_URL+'/home/admin/student/delete/'+full["id"]+'" data-user-firstname-lastname="'+full['firstname']+' '+full['lastname']+'\
